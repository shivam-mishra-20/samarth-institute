    ...
    <div className="min-h-screen bg-samarth-bg font-sans text-gray-800">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden bg-gradient-to-br from-samarth-blue-900 via-blue-800 to-indigo-900 text-white">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            <h2 className="text-xl md:text-2xl font-light text-blue-200 uppercase tracking-widest mb-4">
              Welcome to
            </h2>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight drop-shadow-lg">
              Samarth Institute
            </h1>
            <p className="text-2xl md:text-4xl font-serif text-yellow-400 italic mb-8">
              "Mine Of Confidence"
            </p>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-blue-100/90 text-sm md:text-base font-medium">
              <span className="flex items-center gap-2">
                <FiCheckCircle /> Est. 15th April 2017
              </span>
              <span className="hidden md:inline">•</span>
              <span className="flex items-center gap-2">
                <FiMapPin /> Vadodara, Gujarat
              </span>
            </div>
          </motion.div>
        </div>
            ...
            >
              ...
              >
                <p>
                  ...
                  . Our mission is simple yet profound: to equip students with
                  the deep knowledge and problem-solving skills necessary to
                  excel in their academic and professional pursuits—whether in
                  Engineering (JEE), Medicine (NEET), or any other field.
                </p>
                <p>
                  Founded on{" "}
                ...
                <p>
                  ...
                  learning techniques to make education an enjoyable,
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              ...
              and Olympiads. We envision a future where top-tier education is
              accessible to all.
            </p>
          </motion.div>
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Comprehensive Academic Roadmap
            </h2>
            <p className="text-blue-200 text-lg max-w-3xl mx-auto">
              From building strong foundations in lower classes to rigorous
              competitive preparation in higher secondary, we have a structured
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-samarth-blue-900 mt-2">
                Distinguishing Features
              </h2>
              <p className="text-gray-600 mt-4 text-lg">
                We go beyond traditional teaching to ensure every student
                succeeds.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                desc: "A consistent history of students achieving top national ranks in JEE, NEET, and Olympiads.",
                color: "text-green-600",
                bg: "bg-green-50",
              },
              {
                title: "Comprehensive Curriculum",
                desc: "Meticulously designed syllabus covering all key concepts and advanced problem-solving techniques.",
                color: "text-purple-600",
                bg: "bg-purple-50",
              },
              {
                title: "Individualized Attention",
                desc: "Personalized mentoring, 1-on-1 doubt clearing, and regular performance tracking.",
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed text-sm module-fade">
                  {feature.desc}
                </p>
              </motion.div>
            ))}
              ...
              >
                ...
                <div className="p-8 md:p-10 flex-1">
                  ...
                  <div className="space-y-4 text-gray-600 text-lg">
                    ...
                    <p className="flex items-center">
                      <FiClock className="mr-4 text-blue-600" /> Mon-Sat:
                      8AM-8PM <br /> Sun: 8AM-12:30PM
                    </p>
                  </div>
                </div>
              </motion.div>
