    ...
    <div className="min-h-screen bg-samarth-bg font-sans text-gray-800">
      ...
      <section className="relative pt-32 pb-16 overflow-hidden bg-linear-to-br from-samarth-blue-900 via-blue-800 to-indigo-900 text-white">
        ...
        <div className="container-custom relative z-10 text-center">
            ...
            >
                <h2 className="text-xl md:text-2xl font-light text-blue-200 uppercase tracking-widest mb-2">About Us</h2>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight drop-shadow-lg">Samarth Institute</h1>
                <p className="text-xl md:text-2xl font-serif text-yellow-400 italic mb-4">"Mine Of Confidence"</p>
            </motion.div>
        </div>
        ...
        <div className="container-custom">
            ...
            >
                ...
                <p className="text-lg text-gray-600">
                    To be a global leader in quality education, inspiring students to excel in Board exams and competitive arenas like JEE, NEET, NTSE, and Olympiads.
                </p>
            </motion.div>
                    ...
                    >
                       ...
                       <div className="p-8 md:p-10 flex-1">
                           ...
                           <div className="space-y-4 text-gray-600 text-lg">
                              ...
                              <p className="flex items-center"><FiClock className="mr-4 text-blue-600" /> Mon-Sat: 8AM-8PM, Sun: 8AM-12:30PM</p>
                           </div>
                       </div>
                    </motion.div>
                ))}
        ...
        <div className="w-full lg:w-1/2">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-samarth-blue-900 mb-6 leading-tight">
              Welcome to <span className="text-samarth-blue-700">Samarth Institute</span>
            </h2>
            
            <div className="space-y-6 text-samarth-gray-600 text-lg leading-relaxed">
              <p>
                Samarth Institute is a leading educational center dedicated to fostering academic excellence of each subject for students from Class 6th to 12th. Our mission is to equip students with the knowledge and skills necessary to excel in their academic and professional pursuits, not only in the fields of engineering and medicine but also various fields in which students can do their best.
              </p>
              <p>
                We specialize in comprehensive preparation for competitive exams like JEE and NEET, while also ensuring a strong foundation in board curriculum. Our approach goes beyond rote learning; we focus on concept clarity, critical thinking, and holistic development.
              </p>
              
              <div className="p-6 bg-blue-50 rounded-xl border-l-4 border-samarth-blue-700 italic text-samarth-blue-900 mt-6">
                "We feel, Empowerment is the key stone of Education and the education is fulfilled, when the heart, the intellect and the actions of a person are profound."
              </div>

              <div className="flex items-center gap-4 mt-8">
                <img src="/logo 2.jpg" alt="Samarth Logo" className="h-12 opacity-80" />
                <div>
                  <p className="font-semibold text-gray-900">Samarth Institute</p>
...
const FacultySection = () => (
  <section className="py-20">
      <div className="container-custom">
          <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-samarth-blue-900 mb-6">Our Expert Faculty</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Our team comprises highly qualified and experienced educators who are passionate about teaching and committed to student success.
              </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              {[
                  ...
                  { title: "Advanced Degrees", desc: "Our faculty members hold advanced degrees from premier institutions and bring real-world expertise.", color: "text-green-600", bg: "bg-green-50" },
                  { title: "Teaching Excellence", desc: "Proven track record of producing top rankers and helping students achieve their academic goals.", color: "text-purple-600", bg: "bg-purple-50" },
                  { title: "Personalized Mentoring", desc: "One-on-one doubt clearing sessions, performance tracking, and individualized attention for every student.", color: "text-orange-600", bg: "bg-orange-50" }
              ].map((feature, idx) => (
                  <motion.div 
                    key={idx}
          ...
          <div className="bg-linear-to-r from-blue-600 to-indigo-600 rounded-3xl p-12 text-white text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                  Explore detailed profiles of our experienced educators and their areas of expertise.
              </p>
              <Link 
                  to="/faculty" 
...
const InfrastructureSection = () => (
  <section className="py-20">
      <div className="container-custom">
          <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-samarth-blue-900 mb-6">World-Class Infrastructure</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
              ...
              >
                  ...
                  <div className="p-8">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                          Our classrooms are equipped with modern audio-visual equipment, digital boards, and smart technology to enhance the learning experience and make complex concepts easier to understand.
                      </p>
                  </div>
              </motion.div>
              ...
              >
                  ...
                  <div className="p-8">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                          Extensive collection of reference books, study materials, previous year papers, and digital resources accessible to all students for comprehensive exam preparation.
                      </p>
                  </div>
              </motion.div>
          </div>
...
const ProgrammeSection = () => (
  <>
    <section className="py-20 bg-white">
        <div className="container-custom">
            <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-bold text-samarth-blue-900 mb-6">Comprehensive Academic Programs</h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    From building strong foundations to rigorous competitive preparation, we have structured programs for every academic stage.
                </p>
            </div>
               ...
               {[
                  {
                     ...
                     focus: ["Conceptual Clarity", "Critical Thinking", "Analytical Skills", "Olympiad Introduction"],
                  ...
                  },
                  {
                     ...
                     focus: ["Advanced Subjects", "Board Exam Preparation", "Time Management", "NTSE Training"],
                  ...
                  },
                  {
                     ...
                     focus: ["Physics, Chemistry, Maths/Biology", "Rigorous Training", "Career Counseling", "Board Support"],
                  ...
                  },
                  {
                     ...
                     focus: ["JEE Main & Advanced", "NEET (Medical)", "Problem Solving Techniques", "Mock Tests & Analysis"],
                  ...
                  >
                     <div className="flex items-center justify-between mb-4">
                        <span className="font-bold uppercase tracking-wider text-sm bg-white/20 px-3 py-1 rounded-full">{program.grade}</span>
                        {program.icon}
                     </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-12">
                <h3 className="text-3xl font-bold text-gray-900 mb-6 text-center">What Makes Our Programs Special?</h3>
                <div className="grid md:grid-cols-2 gap-8">
                    {[
                        { title: "Comprehensive Curriculum", desc: "Meticulously designed syllabus covering all key concepts, advanced problem-solving techniques, and exam-oriented preparation." },
                        { title: "Regular Assessments", desc: "Weekly tests, monthly evaluations, and full-length mock exams to track progress and identify areas for improvement." },
                        { title: "Study Material", desc: "Custom-designed study materials, practice worksheets, and question banks created by our experienced faculty team." },
                        { title: "Doubt Clearing Sessions", desc: "Dedicated time slots for individual doubt clearing, extra help, and personalized guidance for every student." }
                    ].map((feature, idx) => (
                        <motion.div
                            key={idx}
