    ...
    <section className="bg-white overflow-hidden">
      ...
      <div className="py-20 container-custom">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h4 className="text-samarth-blue-600 font-bold mb-2 uppercase tracking-wide text-sm">
            ...
            <p className="text-samarth-gray-600 text-lg mb-6 leading-relaxed">
              Welcome to <strong>Samarth Classes</strong>. We aim to
              revolutionize the educational landscape by offering exceptional
              learning experiences. Our mission is to equip students with the
              knowledge and skills necessary to excel in academic and
            ...
            <ul className="grid sm:grid-cols-2 gap-4 mb-8">
              {[
                ...
                <li
                  key={i}
                  className="flex items-center text-samarth-gray-700 font-medium"
                >
                  <FiCheckCircle className="text-samarth-blue-500 mr-2 shrink-0" />{" "}
                  {item}
                </li>
              ))}
            </ul>
            ...
            <Link
              to="/about"
              className="btn-sweep px-8 py-3.5 bg-blue-600 hover:bg-blue-800 text-white font-bold rounded-lg shadow-lg inline-block transition-transform hover:-translate-y-1"
            >
          ...
          >
            ...
            <div className="absolute -top-4 -right-2 md:-top-6 md:-right-6 md:right-10 z-30 bg-samarth-blue-600 text-white p-4 md:p-6 rounded-xl md:rounded-2xl shadow-xl border-2 md:border-4 border-white text-center animate-bounce-slow">
              ...
              <span className="text-[10px] md:text-xs font-semibold uppercase tracking-wider text-samarth-blue-100">
                Years of
                <br />
                Excellence
              </span>
