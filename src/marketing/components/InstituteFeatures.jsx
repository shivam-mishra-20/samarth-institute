...
const features = [
  {
    ...
    description: "Equipped for interactive learning.",
  ...
  },
  {
    icon: <FiVideo />,
    title: "Live Classes",
    description: "Interactive online sessions available.",
    ...
    <section className="py-20 bg-samarth-bg">
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          >
            At Samarth Institute, we provide a range of facilities to support our students’ academic and extracurricular needs:
          </motion.p>
        </div>
