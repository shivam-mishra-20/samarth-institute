    ...
    <Router>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/academic/pre-foundation/class-6" element={<PreFoundationClass6 />} />
          <Route path="/academic/pre-foundation/class-7" element={<PreFoundationClass7 />} />
          <Route path="/academic/pre-foundation/class-8" element={<PreFoundationClass8 />} />
          <Route path="/academic/foundation/class-9" element={<FoundationClass9 />} />
          <Route path="/academic/foundation/class-10" element={<FoundationClass10 />} />
          <Route path="/academic/after-boards/eklavy-neet" element={<AfterBoardsEklavy />} />
          <Route path="/academic/after-boards/arjuna-jee" element={<AfterBoardsArjuna />} />
          <Route path="/academic/integrated/ntse-olympiad" element={<IntegratedNTSE />} />
          <Route path="/academic/integrated/iit-nit" element={<IntegratedIIT />} />
          <Route path="/academic/integrated/neet" element={<IntegratedNEET />} />
